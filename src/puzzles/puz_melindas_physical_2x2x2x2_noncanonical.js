...
let cellgripkeys = [
  ...
  ['KeyX', 'gyro_', false], // Grip Gyro (Rotate Projection around the I/O axis) // Gyros Y/Y' and Z/Z' are the "Physical 2x2x2x2 Gyro Algorithm"
  ['KeyB', 'oryg_', false], // Grip Gyro (Rotate Projection around the UD, FB, and LR axes)
];
const movekeys = [
...
export const melindas_physical_2x2x2x2_noncanonical = {
  ...
  addControls: function () {
    ...
    cellgripkeys.forEach((key, _index) => {
